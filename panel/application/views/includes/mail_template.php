...
<body>
    <div class="container bg-light p-3">
        ...
        <div class="d-flex flex-wrap text-center align-middle align-items-center justify-content-center w-100 mb-3">
            <img src="<?= get_picture("settings_v", get_settings()->logo) ?>" class="img-fluid text-center align-middle align-items-center justify-content-center mx-auto px-auto mb-3" style="max-width: 250px;max-height:250px;" width="250" height="250">
        </div>
        ...
        <?php if (!empty($order_data)) : ?>
            ...
            <div class='table-responsive'>
                <table class="table table-bordered table-striped table-hover w-100" width="100%" border="1">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5" class="text-right"><?= lang("subTotal") ?> : <span class="float-right ml-1"> <?= $order_data["sub_total"] ?><?= $order_data["symbol"] ?></span></td>
                        </tr>
                        <?php if ((float)$order_data["vat"] > 0) : ?>
                            <tr>
                                <td colspan="5" class="text-right"><?= lang("vat") ?> : <span class="float-right ml-1"> <?= $order_data["vat"] ?><?= $order_data["symbol"] ?></span></td>
                            </tr>
                        <?php endif ?>
                        <tr>
                            <td colspan="5" class="text-right"><b><?= lang("total") ?></b> : <span class="float-right ml-1"> <?= $order_data["total"] ?><?= $order_data["symbol"] ?></span></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
