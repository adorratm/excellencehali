...
class Technical_information_model extends CI_Model
{
    public $tableName = "technical_informations";
    public function __construct()
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
