...
class Product_detail_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['codes_id', 'description', 'content', 'features', 'codes', 'createdAt', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['codes_id', 'description', 'content', 'features', 'codes', 'createdAt', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
