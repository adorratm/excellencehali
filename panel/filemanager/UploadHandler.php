...
$rootPath = str_replace("filemanager/config", "", __DIR__);
		//print_r(dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/tinymce/');
		//print_r($this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')));
		//print_r($this->get_full_url().'/uploads/tinymce/');
		//print_r($this->get_full_url());
		//print_r(str_replace("filemanager/","",$this->get_full_url()));
		//die();
        $this->options = array(
            'script_url' => $this->get_full_url().'/filemanager/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => str_replace("filemanager","",$rootPath)."uploads/tinymce/",
            'upload_url' => str_replace("filemanager/","",$base_url)."uploads/tinymce/",
    ...
    protected function get_full_url() {
        ...
        return
            str_replace("/filemanager","",($https ? 'https://' : 'http://').
