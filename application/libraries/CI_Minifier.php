...
require_once APPPATH . 'third_party/JSPacker.php';
/**
...
class CI_Minifier
{
     ...
     * @return bool
     */
    public function enable_obfuscator($level = 3)
    {
     ...
     */
    private static function packerJS($input, $level = 3)
    {
        switch ($level) {
            case 1:
     ...
     * @return mixed
     */
    public function js_packer($input, $level = 3)
    {
