    ...
    <div class="container-fluid px-5">
        <div class="row shopAccessRow align-items-center align-content-center align-self-center shadow p-2">
            ...
            <div class="col-sm-12 col-md-5 col-lg-6 col-xl-7 d-xl-flex my-2">
                <form class="w-100" id="searchCollectionForm" action="<?= !empty($this->uri->segment(3) && !is_numeric($this->uri->segment(3))) ? base_url(lang("routes_product-collections") . "/" . $this->uri->segment(3)) : base_url(lang("routes_product-collections")) ?>" method="GET" enctype="multipart/form-data">
