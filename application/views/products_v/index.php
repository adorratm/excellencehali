...
<script>
    <?php
    $explodedPatternChecks = !empty($_GET["patternChecks"]) ? explode(",", $_GET["patternChecks"]) : [];
    $explodedDimensionChecks = !empty($_GET["dimensionChecks"]) ? explode(",", $_GET["dimensionChecks"]) : [];
    $explodedColorChecks = !empty($_GET["colorChecks"]) ? explode(",", $_GET["colorChecks"]) : [];
    $explodedBrandChecks = !empty($_GET["brandChecks"]) ? explode(",", $_GET["brandChecks"]) : [];
    ?>
