...
<form id="updateAddress" onsubmit="return false" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group mb-3">
        <button aria-label="<?= $settings->company_name ?>" role="button" class="ulinaBTN btnUpdate w-100" data-url="<?= base_url(lang("routes_cart") . "/" . lang("routes_order-address-update") . "/" . $address->id) ?>"><span><?= lang("updateAddressInformation") ?></span></button>
    </div>
</form>